...
class CreateStatement40ResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statement40_results', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('statement40_results');
    }
}
