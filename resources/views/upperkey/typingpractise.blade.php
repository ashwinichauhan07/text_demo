...
<div class="timer" id="timer"></div>
  <div class="main my-5">
      ...
      <div class="content container-fluid">
          ...
          <input type="text" name="institute_id" value="{{ $upperkey->institute_id }}" id="institute_id" hidden>

          <input type="text" name="language_id" value="{{ $upperkey->language_id }}" id="language_id" hidden>

          <h3 id="message"  class="text-white mx-4 text-center my-4">{{$upperkey->desc}}</h3>
    ...
    console.log("time",time);
     ...
     var formData = new FormData();
           ...
           // console.log(student_type.value);
              ...
              xhttp.open("POST","{{ route('upperkey_result') }}", true);
              xhttp.send(formData);
       }       
