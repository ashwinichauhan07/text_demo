  ...
  <div class="main my-5">
      ...
      <div class="content container-fluid">
          ...
          <h1 class="text-white font-weight-bold"> Check your Typing Speed & Accuracy </h1> <br>
           ...
           <input type="text" name="institute_id" value="{{ $lowerkey->institute_id }}" id="institute_id" hidden>

           <input type="text" name="language_id" value="{{ $lowerkey->language_id }}" id="language_id" hidden>


          <h3 id="message"  class="text-white mx-4 text-center my-4">{{$lowerkey->desc}}</h3>
...
function typing_result(speed,wordsCount,correctWords,time,acc){
 ...
 var language_id= document.getElementById("language_id");
  ...
  // console.log("acc",acc);
     ...
     console.log("institute_id",institute_id.value);
     console.log("language_id",language_id.value);
     ...
     var formData = new FormData();
           ...
           // console.log(student_type.value);
              ...
              xhttp.open("POST","{{ route('lowerkey_result') }}", true);
              xhttp.send(formData);
