                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="userType" value="2">
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->name }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->code }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->startExam }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->endExam }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->duration }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->instruction_time }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ $mCQPractiseExam->pass_percentage }}</p>
                                          ...
                                          <div class="form-group col-6">
                                            ...
                                            <p class="alert alert-success">{{ ($mCQPractiseExam->result == 1 ? "Yes" : "No") }}</p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @foreach($mCQPractiseExam->student as $key => $stu_value)
                                    <div class="card mt-1">
