...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4 mt-4">
            <li class="breadcrumb-item active">Create Automatic Question Paper <a class="btn btn-dark" style="margin-left: 48em;" href="{{ route('practise_mcqtestpaper.index') }}">Back</a></li>
        </ol>
            ...
            <div class="col-xl-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('practise_mcqtestpaper.automatic_create_show') }}" method="POST"
                            id="question_form">
                            {{ csrf_field() }}
                        ...
                        <select name="subject_id" class="form-control" id="subject">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="level">Subject Type</label>
                            ...
                            <div class="form-row align-items-center">
                                ...
                                {{-- <div class="form-group col-md-6">
                                              ...
                                              <input type="number" class="form-control ml-3" id="numberQuestion" name="total_writing_question" value="{{ old('total_writing_question') }}"
                                required>
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control ml-3" id="numberQuestionMcq"
                                name="total_mcq_question" value="{{ old('total_mcq_question') }}" required>
                    ...
                    <div class="form-group col-md-6" id="markWrite">

                        <label for="markQuestion">Mark For Each Writing Question</label>
                        <input type="number" class="form-control" id="markQuestion" name="each_writing_mark" value="0"
                            required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="markQuestionMcq" name="each_mcq_mark"
                            value="{{ old('each_mcq_mark') }}" required>

                    </div>


                    <div class="form-group col-md-6" id="negWrite">

                        <label for="markQuestionNegative">Negative Marking for each Writing Question</label>
                        <input type="number" class="form-control" id="markQuestionNegative"
                            name="each_negative_writing_mark" value="0" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="markQuestionNegativeMcq"
                            name="each_negative_mcq_mark" value="{{ old('each_negative_mcq_mark') }}" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="paterTime" name="required_time" step="any"
                            value="1" required>
