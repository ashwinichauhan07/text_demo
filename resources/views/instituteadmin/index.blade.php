            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card bg-info text-white mb-4">
                        <div class="card-body"><i class="fas fa-users"></i>&nbsp;&nbsp;
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{ route('students.repeat_index') }}">Show Student</a>
                            <div class="small text-white">
                                <i class="fas fa-angle-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card bg-dark text-white mb-3">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a class="small text-white stretched-link" href="{{ route('studentinstallments.revenue')}}">Revenue Report</a>
                            <div class="small text-white">
                                <i class="fas fa-angle-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-md-12">
                    ...
                    <option value="{{ $session_value->id }}">{{ $session_value->start_session }}&nbsp;to&nbsp;{{ $session_value->end_session }}</option>
             ...
             <!--   <div class="col-xl-2 col-md-6">
                   ...
                   <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{asset('public/images')}}/{{ $student->student_img }}" style="width: 30% ;" /></td>
                                    ...
                                    @endforeach
                                     ...
                                     @endforeach
                                        ...
                                        <td>
                            <!-- <a href="" class="btn btn-info">Print</a><br> -->
                            <a href="" class="btn btn-dark"><i class="fas fa-lock"></i></a>
                          </td>
                                       <!--  <td>
                                            @if(Cache::has('ip'.$student->user->id))
                                                {!! Cache::get('ip'.$student->user->id) !!}
                                            @endif
                                        </td> -->
                                    </tr>
                                    @endforeach
                ...
                <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" name="myAnchor" id="myAnchor">
                               <table class="table table-striped table-bordered" id="myTable" width="100%" cellspacing="0" class="display">
                                <thead>
                                    <tr>
                                        <th>Sr.No</th>
                                        <th>Student Photo</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $page += 1 }}</td>
                                        <td style="width: 250px;"><img src="{{asset('public/images')}}/{{ $student->student_img }}" style="width: 30%;"></td>
                                        <td>{{ $student->user->name }}&nbsp;&nbsp;{{ $student->father_name }}&nbsp;&nbsp;{{ $student->lastname }}</td>
                                        <td>
                                     @foreach ($student->student_subject as $key => $subject_value)
