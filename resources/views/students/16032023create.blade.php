...
<script>
  foreach(subjectData as key=>)
      console.log("sub",subject_value)
  
  </script>
   
    <!-- <script type="text/javascript">
     window.onload =()=> {
       var student = document.getElementById('student_type')[0];
       var course_id = document.getElementById('course_id')[0];
        console.log(student);
       student.onchange =()=>{
         console.log(student);
