      ...
      <div class="col-xl-12">
        <div class="card mb-4">
         ...
         @if ($message = Session::get('error'))
          ...
          <form action="{{ route('students.repeat_update',$student_repeat->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="firstname" placeholder="Enter First Name" value="{{ $student_repeat->user->name }}" disabled>
                </div>

                <div class="form-group col-md-6">
                    <label for="lastname">Last Name :</label>
                    <input type="text" class="form-control" name="lastname" placeholder="Name" value="{{ $student_repeat->lastname }}" disabled>
                </div>


              <div class="form-group col-md-6">
                <label for="doaddmission">Date Of Addmission :</label>
                <input type="date" name="doaddmission" class="form-control" placeholder="Student Addmission Date" value="{{ $student_repeat->doaddmission }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    @if($student_repeat->student_type == $studentType_value->id)

                    <option value="{{ $studentType_value->id }}" selected disabled>{{ $studentType_value->name }}</option>
            ...
            <div class="subject">
                  <label for="subject_id">Select Subject</label>
                    ...
                    @foreach($student_repeat->student_subject as $key=> $student_value)

                    @if($student_value->old == 0)
              ...
              <div class="batch">
                  <label for="batch">Select Batch</label>
                    ...
                    @foreach ($student_repeat->student_batch as $key => $student_value)
            ...
            <div class="form-group col-md-6">
                ...
                <select id="isession_id" class="form-control" name="isession_id">
                    ...
                    @if($student_repeat->isession_id == $session_value->id)
                ...
                <div class="form-group col-md-6">
                  <label for="sub40wpm">Enter Session Year :</label>
                     <input type="text" name="year" class="form-control" placeholder="Enter Session Year" value="{{ $student_repeat->year }}">
                    </select>
