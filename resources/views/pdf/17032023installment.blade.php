...
<div id="rcorners2">
    <div class="container">
        ...
        <div style="display: inline-block ; font-size: 20px; margin-left:20% ;">
            ...
            <label style="font-size: 15px; color: blue; ">{{ $data['add'] }}</label>&nbsp;
        </div>
    </div>
    <hr>
    <div class="form-group col-md-5">
        <label>Receipt No :{{ $data['receipt_no'] }} </label> &nbsp;
        <label style="padding-left: 19.4em;">Date : {{ $data['date'] }} </label>
    ...
    <div class="container">
        <div class="form-group col-md-5" style="width: 70%; display: inline-block;">
            ...
            <label><b>{{ $data->name }} {{ $data->student->father_name }} {{ $data->student->lastname }}</b></label>
        </div>
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
            <!-- <label>Total Fess: {{ $data->total_amount }}</label> -->
            <label style="background-color:yellow; padding:0.5em  ;">Paid Amount : {{ $data['paid_value'] }}</label>
    ...
    <div class="container">
        ...
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
            <label>Total Paid Fess : {{ $data['paid_amount'] }}</label>
        </div>
    </div>
    ...
    <div class="container">
        <div class="form-group col-md-5" style="width: 70%; display: inline-block;">
            ...
            <label>{{ $data['next_installmentate'] }}</label>
        </div>
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
            <label>Balance Fess : {{ $data['unpaid_amount'] }}</label>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
            <!-- <label>Paid Amount : {{ $data['paid_value'] }}</label> -->
        </div>
    </div>
...
{{--    <div>--}}
{{--       <label style="font-size: 25px; color: blue;">{{ $data['add'] }}</label>--}}
{{--    </div>--}}
...
{{--        <label> {{ $data['student_type'] }}</label>--}}
{{--       </div>--}}
{{--       <hr>--}}

{{--       <label style="padding-left: 70px;">Amount</label><br>--}}
{{--       <hr>--}}
{{--       <label>Total Amount due :{{ $data['total_amount'] }} </label>--}}
{{--       <hr>--}}

{{--       <label>Amount Paid : {{ $data['paid_amount'] }}</label>--}}
{{--        <hr>--}}
{{--        <label>Balance Amount : {{ $data['unpaid_amount'] }}</label>--}}
{{--       <hr>--}}
