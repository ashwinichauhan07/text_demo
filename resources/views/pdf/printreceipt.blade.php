...
<div id="rcorners2">
    <div class="container">
        ...
        <div style="display: inline-block ; font-size: 20px; margin-left:20% ;">
           ...
           <div>
            <label style="font-size: 15px; color: blue; padding-left: 0px;">{{ $data['add'] }}
            </label>&nbsp;
        </div>
    </div>
    <hr>
    ...
    <div class="container">
        <div class="form-group col-md-5" style="width: 70%; display: inline-block;">
            <label>Student Name:- {{ $data->name }} {{ $data['father_name'] }} 
            {{ $data->lastname }}</label>
            <label><b></b></label>
        </div>
    ...
    <div class="container">
        <div class="form-group col-md-5" style="width: 70%; display: inline-block;">
            <label>Subject Name:- {{ $data->sub }}</label>
            <label></label>
        </div>
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
    ...
    <div class="container">
        <div class="form-group col-md-5" style="width: 70%; display: inline-block;">
            <label>Next installment date :- {{ $data['next_installmentate'] }}</label>
            <label></label>
        </div>
        <div class="form-group col-md-5" style="width: 30%; display: inline-block;">
...
<div id="rcorners2">
    ...
    <div style="display: inline-block ; font-size: 20px; margin-left:20% ;">
        ...
        <div>
            ...
            <label style="font-size: 15px; color: blue; padding-left: 0px;">{{ $data['add'] }}</label>&nbsp;
        </div>
    </div>
    <hr>
    <div class="form-group col-md-5">
