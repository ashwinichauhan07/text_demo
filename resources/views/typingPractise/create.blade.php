...
<main>
  <div class="container-fluid">
    <ol class="breadcrumb mb-4 mt-4">
      <li class="breadcrumb-item active">Create Typing Practises</li>
       <a class="btn btn-dark" href="{{ route('typingPractise.index') }}" style="margin-left: 61em;">Back</a>
    </ol>
    <div class="row mt-4">
      <div class="col-xl-12">
        <div class="card mb-4">
          ...
          @endif
            ...
            <form method="POST" action="{{ route('typingPractise.store') }}" enctype="multipart/form-data">
            @csrf
             @method('PUT')
            <div class="form-row">
...
{{--                    <div class="input-group-btn">--}}
                        <label for="document_img">Upload Check List</label>
{{--                        &nbsp; &nbsp;--}}

{{--                        <button class="btn btn-success" id="upload" type="button" style=""><i class="fas glyphicon glyphicon-plus"></i>Add More</button>--}}
...
{{--                <div class="clone hide" id="cloneid" hidden>--}}
{{--                    <div class="hdtuto control-group lst input-group" id="hideinput" style="margin-top:10px">--}}
{{--                        <input type="file" name="typingdata[]" class="myfrm form-control">--}}
{{--                        <div class="input-group-btn">--}}
{{--                            <buttons class="btn btn-danger buttonid" type="button" id="button_hide">Remove</button>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
      ...
      {{--  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script>  --}}
        ...
        window.onload = ()=>{
          ...
          subject_id.onchange = ()=> {
            ...
            xhttp.open("POST", "{{ route('practisetype') }}", true);
            xhttp.send(formData);
            }
          }
