 ...
 <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4 mt-4">
                            <li class="breadcrumb-item active">Create Automatic Question Paper1111</li>
                        </ol>
                            ...
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('mcq_bank.automatic_create_show') }}" method="POST" id="question_form">
                                          {{ csrf_field() }}
                                         ...
                                         <!--  <input type="hidden" name="subject_id" id="subject_id"> -->
                                          ...
                                          <div class="form-group col-md-6">
                                              ...
                                              <label for="level">MCQ Type</label>
      ...
      <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>
        ...
        <script type="text/javascript">
          ...
          // ajax request for question details
              ...
              xhttp.open("POST","{{ route('mcq_bank.get_question_details') }}",true);
