    ...
    <main>
        <div class="container-fluid">
            <ol class="breadcrumb mb-4 mt-4">
                <li class="breadcrumb-item active">Create Typing Test</li>
                <a class="btn btn-dark" href="{{ route('typingtest.index') }}" style="margin-left: 61em;">Back</a>
            </ol>
            <div class="row mt-4">
                <div class="col-xl-12">
                    <div class="card mb-4">
                        ...
                        <!-- If want show all error in one place  -->
                            ...
                            <form method="POST" action="{{ route('typingtest.store') }}" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                <div class="form-row">
